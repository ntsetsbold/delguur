					...
					<div class="m-t-b clearfix">
										...
										<ul class="product-medialist li-m-t unstyled clearfix">
											<li>
												<div class="item clearfix">
													...
													<h5 class="entry-title"><a href="product.php">Inceptos orci hac libero</a></h5>
						...
						<section class="col-xs-12 col-sm-8 col-md-9">
							...
							<section class="products-wrapper">
									...
									<div class="row">
										<div class="col-xs-12 col-sm-6 center-xs">
											...
											<ul class="unstyled inline-li li-m-r-l-sm pull-left">
												<li><a class="round-icon" href="#" data-toggle="tooltip" data-layout="grid" data-title="Switch to List Grid Mode"><i class="iconfont-th"></i></a></li>
												<li><a class="round-icon active" href="#" data-toggle="tooltip" data-layout="list" data-title="Switch to List View Mode"><i class="iconfont-list"></i></a></li>
											</ul>
											<!-- // DISPLAY MODE -->
								...
								<!-- PRODUCT LAYOUT -->
								<div class="products-layout list m-t-b add-cart" data-product=".product" data-thumbnail=".entry-media .thumb" data-title=".entry-title > a" data-url=".entry-title > a" data-price=".entry-price > .price">
									...
									<div class="product" data-product-id="1" data-category="women|women-jeans|women-skirt" data-brand="brand1" data-price="250" data-colors="red|blue|black|white" data-size="S|M|L">
										<div class="entry-media">
											<img data-src="img/dummy/450x600.png" alt="" class="lazyLoad thumb" />
											<div class="hover">
